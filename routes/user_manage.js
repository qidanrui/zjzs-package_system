...
router.get("/detail", function(req, res)
{
	...
	if (!req.query.actid)
	{
		...
		res.render("activity_detail", {activity:activity, isPackage:isPackage});
		return;
	}
	else
	{
...
router.post("/detail", function(req, res)
{
	...
	if (req.body["need_package_or_not"] != null)
		activity.need_package_or_not = req.body["need_package_or_not"];
	for (key in req.body)
	{
