...
var packageticketinfo = require('./routes/packageticketinfo');
var login = require('./routes/login');
var actinfo = require('./routes/activity_info');

var packageactinfo = require('./routes/package_activity_info');
...
app.use('/packageticketinfo', packageticketinfo);
app.use('/packageactinfo', packageactinfo);
